...
def display_banner():
    """Display APEX-FUZZER banner with developer credit."""
    banner = f"""
{Fore.CYAN}
    ╔═══════════════════════════════════════════════╗
    ║              {Fore.YELLOW}APEX-FUZZER v1.0{Fore.CYAN}                ║
    ║         Advanced API Endpoint Discovery       ║
    ║                                               ║
    ║           Developed by: {Fore.GREEN}Osama Eid{Fore.CYAN}            ║
    ╚═══════════════════════════════════════════════╝
{Style.RESET_ALL}
    """
    print(banner)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="APEX-FUZZER - Advanced API Endpoint Discovery Tool"
    )
